        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 text-center">
                    <ul>
                        <li><a href="/controllers/homeCtrl.php">Accueil</a></li>
                        <li><a href="/controllers/homeCtrl.php">Accueil</a></li>
                        <li><a href="/controllers/homeCtrl.php">Accueil</a></li>
                    </ul>
                </div>
...
<div class="containerFooter my-5">
    <!-- Footer -->
    <footer class="text-center text-white" style="background-color: #3f51b5">
                ...
                <div class="row text-center d-flex justify-content-center pt-5">
                    ...
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
                            <a href="/controllers/homeCtrl.php" class="text-white">Accueil</a>
                        </h6>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-2">
                        <h6 class="text-uppercase font-weight-bold">
                            <A HREF="mailto:ideaddevconnect@mail.com">Contact</A>
                        </h6>
                    </div>
                    <!-- Grid column -->
                </div>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2023 Copyright:
            <a class="text-white" href="https://mdbootstrap.com/">Idea Dev Connect</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
